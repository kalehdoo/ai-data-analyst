...
export default function OpenAIResponse({ prompt, onClose }: Props) {
      ...
      <div style={s.modal}>
        ...
        <div style={s.header}>
          <div style={s.headerLeft}>
            <span style={s.openaiIcon}>⬡</span>
            <span style={s.headerTitle}>GPT-4o mini Analysis</span>
        ...
        {!started && (
          <div style={s.sendArea}>
            <button onClick={sendToOpenAI} style={s.sendBtn}>
              ⬡ Send to GPT-4o mini
            </button>
            <p style={s.sendHint}>
              GPT-4o mini will analyze your prompt and generate a full data analysis report.
            </p>
          </div>
        )}
...
const s: Record<string, React.CSSProperties> = {
  ...
  openaiIcon: { fontSize: 18, color: "#10a37f" },
...
const md: Record<string, React.CSSProperties> = {
  ...
  code: {
    ...
    color: "#10a37f", whiteSpace: "pre-wrap" as const, overflowX: "auto" as const,
  },
};